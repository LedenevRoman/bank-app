package com.training.rledenev.services.util;
...
import com.training.rledenev.services.chatmaps.*;
...
public final class BotUtils {
    private static final String INTEREST_RATE_AND_PERIOD = "with an interest rate of %.2f%%" + "\n"
            + "for a period of %s.";
