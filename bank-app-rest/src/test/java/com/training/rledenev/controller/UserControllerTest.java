...
class UserControllerTest {
    ...
    void shouldCreateUser() throws Exception {
        ...
        //when
        String createdUserId = mockMvc.perform(MockMvcRequestBuilders.post("/user/register")
    ...
    void shouldCatchValidationExceptionOnCreateUser() throws Exception {
        ...
        //when
        String errorDataJson = mockMvc.perform(MockMvcRequestBuilders.post("/user/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(csrf())
                        .content(userDtoJson))
        ...
        Assertions.assertEquals("First name can not be empty", errorData.getMessage());
    }
